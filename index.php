<?php
  session_start();
  $rut = './';
  $pag_id = 1;//esto va a lelguar a la clase por medio de la accion
  //$pagina = 'Inicio'; ya no e necesario porq ue usamos el $inf->nombre
  $action = 'index.php';
...
<html class="wide wow-animation" lang="en">
  <head>
    <?php 
      //-traer la informacion y llamar a la accion----
      //---------------------------------------------
      $data = null; $inf = null;
      //---------------------------------------------
      require_once($rut.DIRACT.$action);//llamo a mi accion, ahora guardamos la inforamcion que nos va a retornar la accion dentro de la variable data
      $data = index($rut,$sid,$pag_id);//una ves pasoe stos 3 voy y creo la accion index que apse estos 3 a a clase
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="<?= IMG; ?>logo-default-200x34.png" alt="" width="100" height="17"/><img class="brand-logo-light" src="<?= IMG; ?>logo-inverse-200x34.png" alt="" width="100" height="17"/></a>
                  </div>
                </div>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-10">
              ...
              <div class="owl-carousel review-carousel" data-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-xl-items="1" data-xxl-items="1" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="0" data-mouse-drag="true" data-autoplay="false">
                <div class="item">
                  <div class="item-preview wow fadeInDown" data-wow-delay=".2s"><img src="<?= IMG; ?>user-1-216x216.jpg" alt="" width="216" height="108"/>
                  </div>
                ...
                <div class="item">
                  <div class="item-preview wow fadeInDown" data-wow-delay=".2s"><img src="<?= IMG; ?>user-2-216x216.jpg" alt="" width="216" height="108"/>
                  </div>
                  <div class="item-description wow fadeInUp" data-wow-delay=".3s">
                ...
                <div class="item">
                  <div class="item-preview wow fadeInDown" data-wow-delay=".2s"><img src="<?= IMG; ?>user-3-216x216.jpg" alt="" width="216" height="108"/>
                  </div>
                  <div class="item-description wow fadeInUp" data-wow-delay=".3s">
                ...
                <div class="item">
                  <div class="item-preview wow fadeInDown" data-wow-delay=".2s"><img src="<?= IMG; ?>user-4-216x216.jpg" alt="" width="216" height="108"/>
                  </div>
                  <div class="item-description wow fadeInUp" data-wow-delay=".3s">
